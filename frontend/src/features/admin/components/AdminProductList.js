  ...
  return (
    <div className="bg-white">
      <div>
        ...
        <MobileFilter handleFilter={handleFilter} filters={filters} mobileFiltersOpen={mobileFiltersOpen} setMobileFiltersOpen={setMobileFiltersOpen} />
      ...
      <div className="bg-white">
        <div className="mx-auto max-w-2xl px-4 py-0 sm:px-6 sm:py-0 lg:max-w-7xl lg:px-8">
          <div className="flex justify-end">
            <Link to={'/admin/product-form'} className="rounded-md bg-green-700 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-green-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-600">Add new product
            </Link>
          </div>
          <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:gap-x-8">
            {products.map((product) => (
              <div>
                <div key={product.id} className="group relative bg-slate-100 border-2">
                  <Link to={`/product-detail/${product.id}`}>
                    ...
                    <div className="mt-4 flex justify-between p-2">
                      <div>
                        ...
                        <p className="mt-1 text-sm text-gray-500"><StarIcon className="w-4 h-4 inline" /><span className="align-middle">{product.rating}</span></p>
                      </div>
                      <div>
                      ...
                      {product.active? null:<p className="text-sm text-red-700">This product has been deleted</p>}
                  </Link>
                </div>
                <div className="flex justify-start py-2">
                  <Link to={`/admin/product-form/edit/${product.id}`} className="flex w-1/2 justify-center rounded-md bg-indigo-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                    Edit product
                    </Link>
                </div>
              </div>
